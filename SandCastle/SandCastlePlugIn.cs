...
namespace SandCastle
{
    ...
    [HelpFileBuilderPlugInExport("SandCastle", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "SandCastle plug-in")]
    public sealed class SandCastlePlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In SandCastlePlugIn Execute() method");
        }
        #endregion
